        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('hrms.payroll')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('hrms.accounts')}}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('hrms.report')}}" class="my_sort_cut text-muted">
